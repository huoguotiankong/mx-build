...
interface CommentSource {
    ...
    suspend fun getChapterCommentTarget(
        manga: SManga,
        chapter: SChapter,
    ): CommentTarget = throw UnsupportedOperationException("Chapter comments are not supported")
    ...
    suspend fun getCommentReplies(
        ...
        comment: Comment,
        page: Int,
    ): CommentPage = throw UnsupportedOperationException("Comment replies are not supported")

    suspend fun postComment(
        target: CommentTarget,
        content: String,
    ): Comment = throw UnsupportedOperationException("Posting comments is not supported")

    suspend fun postCommentReply(
        target: CommentTarget,
        parent: Comment,
        content: String,
    ): Comment = throw UnsupportedOperationException("Comment replies are not supported")

    suspend fun setCommentLiked(
        target: CommentTarget,
        comment: Comment,
        liked: Boolean,
    ): Comment = throw UnsupportedOperationException("Comment likes are not supported")
}
