...
abstract class EHentaiPlus :
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        val accountStatusPreference = EditTextPreference(screen.context).apply {
    ...
    private fun memberId() = preferences.getString(cookiePref("ipb_member_id"), preferences.getString(PREF_MEMBER_ID, "").orEmpty()).orEmpty()
