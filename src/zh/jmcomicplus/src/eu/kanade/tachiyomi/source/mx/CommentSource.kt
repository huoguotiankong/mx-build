...
interface CommentSource {
    val commentCapabilities: CommentCapabilities get() = CommentCapabilities()
...
data class CommentCapabilities(val supportsMangaComments: Boolean = true, val supportsChapterComments: Boolean = false, val canPost: Boolean = false, val canReply: Boolean = false, val canLike: Boolean = false, val requiresLoginToPost: Boolean = true)
